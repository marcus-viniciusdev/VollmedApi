...
class MedicoControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver o código 400 quando as informações estão inválidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver código 201 quando as informações estão validas")
    @WithMockUser
